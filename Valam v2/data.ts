...
export const AMENITY_PROVIDERS: AmenityProvider[] = [
  ...
  {
    id: 'p7', name: 'AgroVision Inputs', type: 'inputs',
    rating: 4.6, reliability: 95, isVerified: true, jobs: 241, disputes: 1,
    location: 'Chengalpattu Market', distance: 2.5,
    initials: 'AV', color: '#1B5E20',
    contact: '+91 9876501007',
    services: [
      { id: 's17', name: 'DAP Fertilizer (50kg)', unit: 'bag', price: 1380, available: true },
      { id: 's18', name: 'Potash (50kg)', unit: 'bag', price: 920, available: true },
      { id: 's19', name: 'Zinc Sulphate (25kg)', unit: 'bag', price: 750, available: true },
      { id: 's20', name: 'Neem Oil (1L)', unit: 'bottle', price: 210, available: true },
    ],
  },
  {
    id: 'p8', name: 'Selvan Agro Store', type: 'inputs',
    rating: 4.2, reliability: 88, isVerified: false, jobs: 134, disputes: 3,
    location: 'Madurantakam', distance: 14.2,
    initials: 'SA', color: '#4CAF50',
    contact: '+91 9876501008',
    services: [
      { id: 's21', name: 'Groundnut Seeds (10kg)', unit: 'pack', price: 440, available: true },
      { id: 's22', name: 'Maize Seeds (5kg)', unit: 'pack', price: 370, available: true },
      { id: 's23', name: 'Micronutrient Mix (5kg)', unit: 'pack', price: 290, available: false },
    ],
  },
  {
    id: 'p9', name: 'Vel Modern Machinery', type: 'machinery',
    rating: 4.7, reliability: 97, isVerified: true, jobs: 403, disputes: 1,
    location: 'Tambaram', distance: 10.3,
    initials: 'VM', color: '#FF6F00',
    contact: '+91 9876501009',
    services: [
      { id: 's24', name: 'Combine Harvester (1 acre)', unit: 'acre', price: 2100, available: true },
      { id: 's25', name: 'Paddy Transplanter (1 acre)', unit: 'acre', price: 1500, available: true },
      { id: 's26', name: 'Tractor + Trailer (8hr)', unit: 'day', price: 2500, available: true },
      { id: 's27', name: 'Drone Sprayer (1 acre)', unit: 'acre', price: 650, available: true },
    ],
  },
  {
    id: 'p10', name: 'Saravana Equipments', type: 'machinery',
    rating: 4.1, reliability: 85, isVerified: false, jobs: 67, disputes: 4,
    location: 'Kancheepuram', distance: 22.0,
    initials: 'SE', color: '#795548',
    contact: '+91 9876501010',
    services: [
      { id: 's28', name: 'Mini Tractor (4hr)', unit: 'half-day', price: 1100, available: true },
      { id: 's29', name: 'Thresher Machine (1 day)', unit: 'day', price: 1300, available: false },
    ],
  },
  {
    id: 'p11', name: 'Krishnan Labour Co.', type: 'labour',
    rating: 4.8, reliability: 96, isVerified: true, jobs: 320, disputes: 0,
    location: 'Singaperumalkoil', distance: 8.4,
    initials: 'KL', color: '#5C6BC0',
    contact: '+91 9876501011',
    services: [
      { id: 's30', name: 'Paddy Transplanting Team (5)', unit: 'team/day', price: 2750, available: true },
      { id: 's31', name: 'Harvesting Team (5)', unit: 'team/day', price: 3000, available: true },
      { id: 's32', name: 'Land Levelling Labour', unit: 'person/day', price: 560, available: true },
      { id: 's33', name: 'Pesticide Spraying (skilled)', unit: 'person/day', price: 620, available: true },
    ],
  },
  {
    id: 'p12', name: 'Anbu Farm Labour', type: 'labour',
    rating: 4.4, reliability: 91, isVerified: true, jobs: 178, disputes: 2,
    location: 'Chromepet', distance: 15.6,
    initials: 'AF', color: '#E91E63',
    contact: '+91 9876501012',
    services: [
      { id: 's34', name: 'Dibbling Labour', unit: 'person/day', price: 490, available: true },
      { id: 's35', name: 'Irrigation Management', unit: 'person/day', price: 510, available: true },
      { id: 's36', name: 'General Farm Help', unit: 'person/day', price: 450, available: true },
    ],
  },
];
...
export const SCHEMES: Scheme[] = [
  ...
  },
  {
    ...
    isEligible: true,
    govUrl: 'https://www.nabard.org/content1.aspx?id=593',
  },
  {
    ...
    isEligible: true,
    govUrl: 'https://www.tn.gov.in/scheme/data_view/4803',
  },
  {
    ...
    isEligible: false,
    govUrl: 'https://www.nabard.org/content1.aspx?id=595',
  },
];
